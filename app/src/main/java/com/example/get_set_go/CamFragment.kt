...
class CamFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.button1C.setOnClickListener {  // to navigate from this "CamFragment" to different "ThirdActivity"
            val intent = Intent(this@CamFragment.requireContext(),StyleOvalActivity::class.java)
            startActivity(intent)
        }
        binding.button2C.setOnClickListener {  // to navigate from this "CamFragment" to different "ThirdActivity"
            val intent = Intent(this@CamFragment.requireContext(),StyleRoundActivity::class.java)
            startActivity(intent)
        }
        binding.button3C.setOnClickListener {  // to navigate from this "CamFragment" to different "ThirdActivity"
            val intent = Intent(this@CamFragment.requireContext(),StyleTriangleActivity::class.java)
            startActivity(intent)
        }
        binding.button4C.setOnClickListener {  // to navigate from this "CamFragment" to different "ThirdActivity"
            val intent = Intent(this@CamFragment.requireContext(),StyleSquareActivity::class.java)
            startActivity(intent)
        }
        binding.button5C.setOnClickListener {  // to navigate from this "CamFragment" to different "ThirdActivity"
            val intent = Intent(this@CamFragment.requireContext(),StyleDiamondActivity::class.java)
            startActivity(intent)
        }
        binding.button6C.setOnClickListener {  // to navigate from this "CamFragment" to different "ThirdActivity"
            val intent = Intent(this@CamFragment.requireContext(),StyleRectangularActivity::class.java)
            startActivity(intent)
        }
