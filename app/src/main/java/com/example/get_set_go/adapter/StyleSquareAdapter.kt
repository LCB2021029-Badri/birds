...
class StyleSquareAdapter(private val onItemClicked: (Style) -> Unit) :
    ListAdapter<Style, StyleSquareAdapter.StyleSquareViewHolder>(DiffCallback) {

    private lateinit var context: Context

    class StyleSquareViewHolder(private var binding: StyleOvalListItemBinding) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): StyleSquareViewHolder {
        context = parent.context
        return StyleSquareViewHolder(
    ...
    override fun onBindViewHolder(holder: StyleSquareViewHolder, position: Int) {
