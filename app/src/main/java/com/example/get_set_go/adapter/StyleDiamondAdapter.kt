...
class StyleDiamondAdapter(private val onItemClicked: (Style) -> Unit) :
    ListAdapter<Style, StyleDiamondAdapter.StyleDiamondViewHolder>(DiffCallback) {

    private lateinit var context: Context

    class StyleDiamondViewHolder(private var binding: StyleOvalListItemBinding) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): StyleDiamondViewHolder {
        context = parent.context
        return StyleDiamondViewHolder(
    ...
    override fun onBindViewHolder(holder: StyleDiamondViewHolder, position: Int) {
