...
class StyleRoundAdapter(private val onItemClicked: (Style) -> Unit) :
    ListAdapter<Style, StyleRoundAdapter.StyleRoundViewHolder>(DiffCallback) {

    private lateinit var context: Context

    class StyleRoundViewHolder(private var binding: StyleOvalListItemBinding) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): StyleRoundViewHolder {
        context = parent.context
        return StyleRoundViewHolder(
    ...
    override fun onBindViewHolder(holder: StyleRoundViewHolder, position: Int) {
