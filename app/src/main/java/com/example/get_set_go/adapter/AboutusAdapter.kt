...
import com.example.get_set_go.databinding.SportsListItemBinding
import com.example.get_set_go.model.Sport

class AboutusAdapter(private val onItemClicked: (Sport) -> Unit) :
    ListAdapter<Sport, AboutusAdapter.SportsViewHolder>(DiffCallback) {

    private lateinit var context: Context

    class SportsViewHolder(private var binding: AboutusListItemBinding) :
