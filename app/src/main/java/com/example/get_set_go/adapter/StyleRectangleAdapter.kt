...
class StyleRectangleAdapter(private val onItemClicked: (Style) -> Unit) :
    ListAdapter<Style, StyleRectangleAdapter.StyleRectangleViewHolder>(DiffCallback) {

    private lateinit var context: Context

    class StyleRectangleViewHolder(private var binding: StyleOvalListItemBinding) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): StyleRectangleViewHolder {
        context = parent.context
        return StyleRectangleViewHolder(
    ...
    override fun onBindViewHolder(holder: StyleRectangleViewHolder, position: Int) {
